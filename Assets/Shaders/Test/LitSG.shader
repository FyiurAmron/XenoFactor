Shader "Shader Graphs/LitSG mod"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float3 posMod = fmod(IN.WorldSpacePosition,1);
            surface.BaseColor = float3(0.5,0.5,0.5) * ( sin(IN.WorldSpacePosition.x + IN.WorldSpacePosition.z) + 1 );
